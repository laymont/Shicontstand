...
it('TypeGroupRepository has model', function () {
    ...
    expect($repository->all())->toBeInstanceOf(Collection::class);
});
...
it('EloquentRepository can query', function () {
    ...
    expect($repository->query())->toBeInstanceOf(Builder::class);
});
...
it('TypeGroup has relationship with SizeType', function () {
    ...
    expect($model->sizeTypes())->toBeInstanceOf(HasMany::class);
});
